...
import BottomSheet, {BottomSheetBackdrop, BottomSheetProps, useBottomSheetSpringConfigs} from '@gorhom/bottom-sheet';
...
const UIBottomSheet = React.forwardRef<Ref, UIBottomSheetProps>(
