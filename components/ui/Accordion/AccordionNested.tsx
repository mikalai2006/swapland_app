...
import {NestedItem} from './Accordion';
...
const AccordionNested = ({value, parentHeighValue}: Props) => {
                ...
                onPress={() => {
                    if (heightValue.value === 0) {
                        runOnUI(() => {
                            ...
                            parentHeighValue.value = withTiming(parentHeighValue.value + measure(listRef)!.height);
                        })();
                    } else {
                        runOnUI(() => {
                            'worklet';
